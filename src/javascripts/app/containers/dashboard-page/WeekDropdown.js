...
class WeekDropdown extends React.Component {
  ...
  render() {
    ...
    const baseButtonClasses = 'bg-blue-500 p-3 text-white';
    ...
    const rightButtonClasses = cx(baseButtonClasses, 'rounded-r', {
      ...
      'hover:bg-blue-600': !isCurrent
    });

    const selectClasses =
      'block bg-blue-500 text-white appearance-none outline-none ' +
      'px-4 py-2 pr-10 h-full cursor-pointer';
